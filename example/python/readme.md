# Using LCM Lightweight Communications and Marshalling
...
### run in real robot
Before running on the real robot, make sure the robot is `HANGING` properly.  The foot should be off the ground. Double check before use!!!  
